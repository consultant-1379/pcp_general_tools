...
#ifdef IPOQUE_TOH_MULTI_TIMEOUT
 ...
 * @param queues the number of used queues, maximum is 1024
 * @return returns 0 for success, != 0 for error. Max number of queues is TOH_MAX_MULTI_TIMEOUTS
 */
