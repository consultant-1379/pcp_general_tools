...
#define IPOQUE_LAST_IMPLEMENTED_PROTOCOL        222

#ifdef IPOQUE_USER_DEFINED_PROTOCOLS

#define IPOQUE_MAX_SUPPORTED_PROTOCOLS          255
#define IPOQUE_USER_DEFINED_MAX_PROTOCOLS (IPOQUE_MAX_SUPPORTED_PROTOCOLS - IPOQUE_LAST_IMPLEMENTED_PROTOCOL)
